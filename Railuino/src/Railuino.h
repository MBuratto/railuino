...
/**
 * An easy means of cotrolling actors not directly connected to the track, that
 * is, not using any digital protocols. This is basically an inverted S88 bus
 * that drives binary outputs instead of the inputs. It is mainly meant to
 * switch on or off simple "1-bit-things" like LEDs. 
 */
// TBD
...
IR
- *Headlights:  Licht an / Licht aus
- *Functions:   Alle 16 Funktionen einmal durch
- *Direction:   Vorwärts rückwärts
- SlowDrive:   Langsam hin und her
- *Turnout: Weiche links / rechts
- CommuterTrain: Pendelzug 1/2

- Headlights:  Licht an / Licht aus
- Functions:   Alle 16 Funktionen einmal durch
- Direction:   Vorwärts rückwärts
- SlowDrive:   Langsam hin und her
- Turnout2Way: Weiche links / rechts
- Turnout3Way: Weiche links / rechts
- Signal:     (kaufen?)
- S88:         Kontaktgleis
- Mfx Erkennung
- CVs schreiben (MM2 / DCC / MFX)
- CVs lesen
- LocoInfo (Name?)
- Fahrgerät (Potis)
- Diagnosis (im Protokoll implementieren)
- CommuterTrain: Pendelzug 1/2
- Rangieren mit Telex
- OvalTwoTrains
- Decoder-Erkennung
